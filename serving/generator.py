...
RULES:
1. Every claim MUST end with an inline citation referring to the context chunk ID, e.g., [Chunk child_abc123].
2. If the answer cannot be directly derived from the context, respond strictly with:
   "The requested information is not found in the indexed documents."
